...
<?php if(current_user()): ?>
<div class="nav-group"><a href="/dashboard">Dashboard</a><a href="/accounts">Accounts</a><a href="/trades">Trades</a><a href="/analytics">Analytics</a><a href="/import">Import</a><a href="/imports">Import History</a><a href="/data-management">Data</a><a href="/audit-log">Audit Log</a><a href="/export?format=json">Backup</a></div>
